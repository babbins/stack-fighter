...
var data = {
    ...
    [
        ...
        {name:  'Akuma', portrait: 'http://imgur.com/NHOmUpU', price: '$1000', strength: '10', intelligence: '10', speed: '10', luck: '2'},
        {name:  'Blanka', portrait: 'http://imgur.com/Z46SkfV', price: '$1000', strength: '8', intelligence: '2', speed: '9', luck: '6'},
        {name:  'Bison', portrait: 'http://imgur.com/hGZqK5C', price: '$1000', strength: '8', intelligence: '8', speed: '4', luck: '4'},
        {name:  'Zangief', portrait: 'http://imgur.com/Jal26u4', price: '$1000', strength: '10', intelligence: '3', speed: '5', luck: '5'}
    ],
    Category:
    [
    ...
    User: [
        {email: 'admin@admin.com', password: 'admin', first_name: 'Admin', last_name: 'Mcadminson'},
        {email: 'user@user.com', password: 'user', first_name: 'User', last_name: 'Mcuserson'}
    ]
};
